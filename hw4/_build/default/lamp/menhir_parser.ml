...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState022 : (('s, 'r) _menhir_cell1_ty, 'r) _menhir_state
    (** State 022.
        Stack shape : ty.
        Start symbol: <undetermined>. *)
...
include struct
  ...
  and _menhir_run_022 : type  ttv_stack ttv_result. (ttv_stack, ttv_result) _menhir_cell1_ty -> _ -> _ -> ttv_result =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer ->
  ...
  and _menhir_run_023 : type  ttv_stack ttv_result. ((ttv_stack, ttv_result) _menhir_cell1_ty as 'stack) -> _ -> _ -> _ -> ('stack, ttv_result) _menhir_state -> _ -> ttv_result =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TIMES ->
          let _menhir_stack = MenhirCell1_ty (_menhir_stack, _menhir_s, _v) in
      ...
      | THINARROW ->
          let _menhir_stack = MenhirCell1_ty (_menhir_stack, _menhir_s, _v) in
          _menhir_run_019 _menhir_stack _menhir_lexbuf _menhir_lexer
      | BAR | CCLEAR | CLET | CLOAD | COLON | COMMA | CONS | CPRINT | CSAVE | CSYNTH | DOT | ELSE | END | EOF | EQ | GT | IN | IS | LT | PLUS | RBRACK | RPAREN | SUB | THEN | WITH ->
